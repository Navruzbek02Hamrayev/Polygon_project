...
class Triangle:
    ...
    def get_type(self) -> str:
        ...
        '''
        if self.a==self.b or self.a==self.c or self.b==self.c or self.a==self.b==self.c:
            return  'Teng yonli'
    ...
    def area(self) -> float:
        ...
        '''
        return sqrt((self.a+self.b+self.c)/2*((self.a+self.b+self.c)/2-self.a)*((self.a+self.b+self.c)/2-self.b)*((self.a+self.b+self.c)/2-self.c))
